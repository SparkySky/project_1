...
class RapidLocationService extends ChangeNotifier {
  ...
  Future<void> _startForegroundService() async {
    try {
      ...
      if (isRunning) {
        print('[RapidLocation] ⚠️ Foreground service already running');
        return;
      }
      ...
      await service.configure(
        ...
        androidConfiguration: AndroidConfiguration(
          onStart: (service) {
            print('[RapidLocation] ✅ Foreground service started');
          },
      ...
      print(
        '[RapidLocation] ✅ Android foreground service started successfully',
      );
    } catch (e) {
      print('[RapidLocation] ⚠️ Failed to start foreground service: $e');
  ...
  Future<void> _stopForegroundService() async {
    try {
      ...
      if (isRunning) {
        ...
        print('[RapidLocation] ✅ Foreground service stopped');
      }
    } catch (e) {
      print('[RapidLocation] ⚠️ Error stopping foreground service: $e');
    }
  }
