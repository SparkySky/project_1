  ...
  List<TutorialStep> get _steps {
    ...
    return [
      TutorialStep(
        title: "Your Profile",
        description:
            "Manage your settings and customize your safety preferences.",
        highlightArea: null,
      ...
      TutorialStep(
        title: "Personal Info",
        description:
            "Add your phone number and address for location-based features.",
        highlightArea: HighlightArea(
          top: appBarHeight + statusBarHeight + 300 - 2,
          height: 380,
        ),
      ...
      TutorialStep(
        ...
        description:
            "Choose your language so AI can better detect emergency sounds.",
        highlightArea: HighlightArea(
          top: appBarHeight + statusBarHeight,
          height: 420,
        ),
        position: TutorialPosition.bottom,
        scrollToPosition: 1140,
      ),
      TutorialStep(
        title: "Emergency Keywords",
        description:
            "Tap 'Edit All Custom Keywords' to add words that trigger emergency alerts.",
        highlightArea: HighlightArea(
          top: appBarHeight + statusBarHeight + 470,
          height: 80,
        ),
        position: TutorialPosition.top,
      ...
      TutorialStep(
        ...
        description:
            "Allow Discoverable = Let others find you\nAllow Emergency Alerts = Get incident notifications",
        highlightArea: HighlightArea(
          top: appBarHeight + statusBarHeight + 160 - 28,
          height: 170,
        ),
        position: TutorialPosition.bottom,
      ...
      TutorialStep(
        ...
        description: "Tap here anytime to review the tutorials.",
        highlightArea: HighlightArea(
          top: appBarHeight + statusBarHeight + 280 - 50,
          height: 180,
        ),
        position: TutorialPosition.bottom,
      ...
      TutorialStep(
        title: "Legal Info",
        description: "View Terms & Conditions and Privacy Policy.",
        highlightArea: HighlightArea(
          top: appBarHeight + statusBarHeight + 150 - 12 - 40,
          height: 270,
        ),
        position: TutorialPosition.bottom,
      ...
      TutorialStep(
        title: "All Done! 🎉",
        description:
            "You're ready to use MYSafeZone!\n\nReplay tutorials anytime from your profile. Stay safe!",
        highlightArea: null,
        position: TutorialPosition.center,
        scrollToPosition: 0,
      ),
